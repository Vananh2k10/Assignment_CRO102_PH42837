    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ width: '100%', gap: 20, alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ fontWeight: 'bold', textAlign: 'center', justifyContent: 'center', fontSize: 30 }}>Đăng ký</Text>
                <Text style={{ textAlign: 'center', justifyContent: 'center', fontSize: 20 }}>Tạo tài khoản</Text>
